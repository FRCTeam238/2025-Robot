...
public class Constants {
    ...
    public class PivotConstants {
        ...
        public static double maxAccel = 800; // Max = 12,146 degrees/s^2
    ...
    public class WristConstants {
        ...
        public static double kP = .35; //last is .42
        public static double kI = 0;
        public static double kD = 0;
        ...
        public static double kV = 1.24; // V/s*rad
        ...
        public static double maxVelocityTolerance = 0.5;
